        ...
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            <div className="mt-1 flex items-center gap-1">
              ...
              {freelancer?.user && freelancer.user.honorScore !== undefined && (
                <span
                  title="Honor Score"
                  className={`ml-2 inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[10px] font-black ring-1 ${
                    freelancer.user.honorScore < 35
                      ? "bg-red-50 text-red-700 ring-red-100 dark:bg-red-500/10 dark:text-red-200 dark:ring-red-500/20"
                      : freelancer.user.honorScore < 75
                ...
                >
                  Score: {freelancer.user.honorScore}
                </span>
              )}
            </div>
